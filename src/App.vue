...
export default {
  ...
  methods: {
    ...
    async leerBateria() {
      try {
        const response = await axios.get(`http://${import.meta.env.VITE_API_HOST}:3000/bateria`)
    ...
    async fetchUserProfile() {
      try {
        ...
        const response = await axios.get(
          `http://${import.meta.env.VITE_API_HOST}:3000/me`,
    ...
    async login_fcn() {
      try {
        ...
        const response = await axios.post(`http://${import.meta.env.VITE_API_HOST}:3000/login`, userData)
    ...
    async registro_fcn() {
      try {
        ...
        const response = await axios.post(`http://${import.meta.env.VITE_API_HOST}:3000/usuarios`, userData)
    ...
    async fetchWaterToday() {
      try {
        ...
        const response = await axios.get(
          `http://${import.meta.env.VITE_API_HOST}:3000/usuarios/${userId}/consumos/hoy`,
          { headers: { 'x-auth-token': token } }
        )
