...
export default {
  ...
  methods: {
    ...
    async leerBateria() {
      try {
        const response = await axios.get(`https://${process.env.VUE_APP_API_HOST}/bateria`)
    ...
    async fetchUserProfile() {
      try {
        ...
        const response = await axios.get(
          `https://${process.env.VUE_APP_API_HOST}/me`,
    ...
    async login_fcn() {
      try {
        ...
        const response = await axios.post(`https://${process.env.VUE_APP_API_HOST}/login`, userData)
    ...
    async fetchRacha() {
      try {
        ...
        const response = await axios.get(
          `https://${process.env.VUE_APP_API_HOST}/usuarios/${userId}/racha`,
          { headers: { 'x-auth-token': token } }
        )
    ...
    async registro_fcn() {
      try {
        ...
        const response = await axios.post(`https://${process.env.VUE_APP_API_HOST}/usuarios`, userData)
    ...
    async fetchWaterToday() {
      try {
        ...
        const response = await axios.get(
          `https://${process.env.VUE_APP_API_HOST}/usuarios/${userId}/consumos/hoy`,
          { headers: { 'x-auth-token': token } }
        )
